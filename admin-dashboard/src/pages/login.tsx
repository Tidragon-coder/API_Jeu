  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-900">
      ...
      >
        ...
        <button  className="w-full bg-red-600 hover:bg-blue-700 p-2 rounded font-semibold transition-colors mt-4" onClick={() => navigate("/register")}>Creer un compte ou tu es morttt</button>
