...
import SideBarGames from "../components/organisme/SideBarGames";
...
export default function Games() {
  ...
  const handlePutUser = (gamesID: string) => {
    setSelectedGame(gamesID)
